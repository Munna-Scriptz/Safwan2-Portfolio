        ...
        <section id='AboutMe' className='mt-[120px]'>
            <div className="container">
                <div id="AllDiv" className='flex lg:flex-row flex-col items-center justify-between'>
                    <div id="LeftSide" data-aos="fade-right">
                    ...
                    <div id="RightSide" className='lg:w-[570px] lg:mt-0 mt-5 w-full'>
                        ...
                        <p className='text-[16px] text-primary opacity-[0.7]' data-aos="fade-up">Quisruam est, qui dolorem ipsum quia dolor sit amet, consecteaur aeci velit, sed quia non numquam eius modi tempora incidunt lao magnam aliquam quaerat voluptatem reprehenderit.</p>
                        <p className='text-[16px] text-primary opacity-[0.7] mt-[50px] mb-[67px]' data-aos="fade-up">Modi tempora incidunt ut lao magnam aliquam quaerat voluptatem reprehenderit non numquam eius.</p>
                ...
                <div className='mt-[80px] flex lg:flex-row flex-col lg:gap-0 gap-5 items-center justify-between'>
                    <div className='flex flex-col gap-[24px] items-center' data-aos="fade-up">
